...
namespace newCRUD.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        private static readonly List<Movie> _movies = new()
        {
            ...
            new Movie { Id = Guid.NewGuid(), Title = "FinalDestination",   Genre = "Horror",   Year = 2004 },
            new Movie { Id = Guid.NewGuid(), Title = "Matrix",       Genre = "Sci-Fi", Year = 2000 },
            new Movie { Id = Guid.NewGuid(), Title = "SanAndreas",Genre = "Action",   Year = 2018 },
            new Movie { Id = Guid.NewGuid(), Title = "LionKing",           Genre = "Action",   Year = 1990 }
        };
