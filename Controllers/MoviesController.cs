...
namespace newCRUD.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        private static readonly List<Movie> _movies = new()
        {
            ...
            new Movie { Id = Guid.NewGuid(), Title = "TheGodfather", Genre = "Crime", Year = 1972 },
            new Movie { Id = Guid.NewGuid(), Title = "Titanic", Genre = "Romance", Year = 1997 },
            new Movie { Id = Guid.NewGuid(), Title = "TheDarkKnight", Genre = "Action", Year = 2008 },
        ...
        )
        {
            ...
            {
                query = query.Where(m => m.Genre.Equals(genres, StringComparison.OrdinalIgnoreCase));
            }
