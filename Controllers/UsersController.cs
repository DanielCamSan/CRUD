...
namespace newCRUD.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            new User { Id = Guid.NewGuid(), name = "Alice", home = "Cochabamba", age = 28 },
            new User { Id = Guid.NewGuid(), name = "Bob", home = "La Paz", age = 35 }
        };
        ...
        public ActionResult<User> Patch(Guid id, [FromBody] User partial)
        {
            ...
            if (!string.IsNullOrEmpty(partial.home)) user.home = partial.home;
